		 ...
		 before and after the collection of data:
			...
			\begin{columns}
				\begin{column}{0.5\textwidth}
					\begin{itemize}
						\small
						\item \underline{Right to be informed}
				...
				\begin{column}{0.5\textwidth}
					\begin{itemize}
						...
						\item Rights w.r.t. automated decisions
					\end{itemize}
				\end{column}
			\end{columns}
			\vspace{0.5cm}
...
\begin{center}
	...
	\vspace{0.5cm}
	{\\ \large
	..that's not what you find in the top 26 771 apps.}
...
\begin{block}{Tracking by revenue and recency}
	\begin{figure}
		...
		\caption{ \ 
		If any trackers are used, then analytics almost always is.
		Whilst the policies of
		paid apps bring trackers less likely than free ones, they 
		are often provide no privacy policy.
		(\textasciitilde7600
			apps/collection) }
	\end{figure}
\end{block}
...
\begin{block}{Tracking by platform}
	\begin{figure}
		...
		\caption{ \ The differences in privacy policy tracking between the 
		platforms are marginal. 
		(\textasciitilde4000 
			apps/country)}
	\end{figure}
\end{block}
...
\begin{column}{\onecolwid} % The third column
	\begin{block}{Tracking by store country}
		\begin{figure}
			...
			\caption{ \ The differences in privacy policy tracking between 
...
\begin{columns}[t]
	...
	\begin{column}{\onecolwid} % The first column
		...
		\begin{block}{Conclusions}
			\begin{itemize}
				...
				numerous studies found and confirmed herein.
	...
	\begin{column}{\onecolwid} % The second column
		...
		\begin{alertblock}{Join the mailing list}
			...
			\\ \includegraphics[width=0.31\textwidth]{figures/email_qr.eps}
	...
	\begin{column}{\onecolwid} % The third column
		\begin{block}{Mock-Up: Privacy Mission Control}
			\begin{figure}
				\includegraphics[width=0.725\textwidth]{figures/mock.png}
			\end{figure}
		\end{block}
	\end{column}
